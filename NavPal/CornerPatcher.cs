...
namespace NavPal
{
    ...
    public static class CornerPatcher
    {
        ...
        /// <summary>
        /// Vertical slack allowed between a patch area's corner and the neighbours it is meant to sit
        /// flush against. Corner heights come from real ground samples on both sides, so this only needs
        /// to absorb floating point drift, not a genuine height difference.
        /// </summary>
        private const float CornerTolerance = 0.5f;
